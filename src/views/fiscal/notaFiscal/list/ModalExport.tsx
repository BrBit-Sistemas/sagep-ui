  ...
  return (
    ...
    >
      <DialogContent sx={{ px: { xs: 8, sm: 15 }, py: { xs: 8, sm: 12.5 }, position: 'relative' }}>
        ...
        <Box sx={{ mb: 8 }}>
          <Typography variant='h5'>Exportar lista de nfse's.</Typography>
                ...
                <Controller
                  ...
                  render={({ field: { value, onChange } }) => (
                    <>
                      ...
                      <Select labelId='status-select-label' label='Status' value={value} onChange={onChange}>
            ...
            <Grid item xs={6} sx={{ mb: 2 }}>
              <FormControl fullWidth>
                <Controller
                  ...
                  control={control}
                  render={({ field: { value, onChange } }) => (
                    <TextField value={value} onChange={onChange} label='Número da nota' type='number' />
                  )}
                />
              </FormControl>
            </Grid>
            <Grid item xs={6} sx={{ mb: 2 }}>
              <FormControl fullWidth>
                <Controller
                  ...
                  control={control}
                  render={({ field: { value, onChange } }) => (
                    <TextField value={value} onChange={onChange} label='Cód. da chamada' type='number' />
                  )}
                />
              </FormControl>
            </Grid>
            ...
            <Grid item xs={6} sx={{ mb: 2 }}>
              <FormControl fullWidth>
                <Controller
                  ...
                  control={control}
                  render={({ field: { value, onChange } }) => (
                    <TextField value={value} onChange={onChange} label='Cód. da empresa' type='number' />
                  )}
                />
              </FormControl>
            </Grid>
            <Grid item xs={6} sx={{ mb: 2 }}>
              <FormControl fullWidth>
                <Controller
                  ...
                  control={control}
                  render={({ field: { value, onChange } }) => (
                    <TextField value={value} onChange={onChange} label='Cód. do convênio' type='number' />
                  )}
                />
              </FormControl>
            </Grid>
